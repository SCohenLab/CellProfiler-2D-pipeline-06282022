...
incomplete_LD <- `CellP_2D_06282022__LD.csv` %>% 
  select(ImageNumber, AreaShape_Area, AreaShape_Eccentricity, AreaShape_FormFactor, AreaShape_MajorAxisLength, AreaShape_MinorAxisLength) %>% 
  group_by(ImageNumber) %>% 
  summarise(
...
number_have_LD <- `CellP_2D_06282022__LD.csv` %>%
...
#Lysosomes Proximity
LS_Proximity <- `CellP_2D_06282022__LS.csv` %>% 
...
MT_Proximity <- `CellP_2D_06282022__MT.csv` %>% 
...
#Golgi Proximity 
GL_Proximity <- `CellP_2D_06282022__GL.csv` %>% 
...
PO_Proximity <- `CellP_2D_06282022__PO.csv` %>% 
...
#ER Proximity
ER_Proximity <- `CellP_2D_06282022__ER.csv` %>% 
...
#LD Proximity
#LD_Proximity <- `CellP_2D_06282022__LD.csv` %>% 
...
area_counts <- `CellP_2D_06282022__Image.csv` %>% 
...
meta <- `CellP_2D_06282022__Image.csv` %>% 
  summarise(ImageNumber = ImageNumber, group = Metadata_SampleName, ImageName = FileName_SomaGreyScale)
SO <- `CellP_2D_06282022__SO.csv` %>% summarise(ImageNumber = ImageNumber, SO_ecty = AreaShape_Eccentricity)
...
organelle_2MCS_overlap <- `CellP_2D_06282022__Image.csv` %>% 
...
organelle_3MCS_overlap <- `CellP_2D_06282022__Image.csv` %>%
...
organelle_4MCS_overlap <- `CellP_2D_06282022__Image.csv` %>%
...
organelle_5MCS_overlap <- `CellP_2D_06282022__Image.csv` %>%
...
organelle_6MCS_overlap <- `CellP_2D_06282022__Image.csv` %>%
...
#Lysosomes neighbors
LS_neighbor <- `CellP_2D_06282022__LS.csv` %>% 
...
MT_neighbor <- `CellP_2D_06282022__MT.csv` %>% 
...
#Golgi neighbors
GL_neighbor <- `CellP_2D_06282022__GL.csv` %>% 
...
PO_neighbor <- `CellP_2D_06282022__PO.csv` %>% 
...
ER_neighbor <- `CellP_2D_06282022__ER.csv` %>% 
...
IndividualOrganelle_Distribution_data <-  `CellP_2D_06282022__SO.csv` %>%
...
Contacts_2MCS_Distribution_data <- `CellP_2D_06282022__SO.csv` %>% 
